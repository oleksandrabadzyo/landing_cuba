...
(0, _carousel.initCarousel)({ animationSpeed: 500 });

// CURRENCY SELECT

var container = document.querySelector('.select');
var flag = document.querySelector('.select__flag');
var header = document.querySelector('.select__header');
var header_text = document.querySelector('.select__text');
...
function selectOption() {
    ...
    var flag_src = this.getElementsByTagName('img')[0].src;
...
function mainMenu() {
    var menuItems = Array.from(document.querySelectorAll('.global-nav__item'));
    var activeClassName = 'global-nav__item_active';
...
function initCarousel(args) {
    ...
    var params = Object.assign(default_params, args);

    var carouselNode = document.querySelector(params.parentNodeSelector);
    var buttonLeft = carouselNode.querySelector(params.btnLeftSelector);
    var buttonRight = carouselNode.querySelector(params.btnRightSelector);
    var items = Array.from(carouselNode.querySelectorAll(params.itemSelector));
...
"use strict";
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/*! jQuery UI - v1.12.1 - 2018-11-03
* http://jqueryui.com
